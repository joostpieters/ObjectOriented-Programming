 ...
 *  
 *  @invar	Each projectile has a proper world
 *  		|hasProperWorld()
 *  @invar	Each projectile has a proper weapon
 *  		|hasProperWeapon()
 * 		
 */
public class Projectile extends Entity{
	...
	/**
	 * Check whether this projectile has a proper world
	 * 
	 * @return	|Result == (world == null) || (world != null && !world.isTerminated())
	 * 
	 */
	@Override
	public boolean hasProperWorld() {
		// TODO Auto-generated method stub
		return (world == null) || (world != null && !world.isTerminated());
	}
	
	/**
	 * Check whether this projectile has a proper projectile
	 * 
	 * @return	|Result == !weapon.isTerminated;
	 * 
	 */
	public boolean hasProperWeapon()
	{
		return !weapon.isTerminated;
	}
