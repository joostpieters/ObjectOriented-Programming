...
public class PartialFacadeTest {
	...
	public void testMoveHorizontal() {
		Worm worm = facade.createWorm(world, 1, 2, 0, 1, "Test", null);
		assertEquals(true, !facade.isImpassable(world, worm.getX(), worm.getY(), worm.getRadius()));
		assertEquals(true, facade.isAdjacent(world, worm.getX(), worm.getY(), worm.getRadius()));
		facade.move(worm);
	...
	public void testProgram() {
		...
		facade.createWorm(world, 50, 50.51, 0, .5, "Lol", null);
