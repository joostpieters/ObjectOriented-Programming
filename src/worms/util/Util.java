...
public class Util {
	...
	{
		return fuzzyLessThanOrEqualTo(x, y, EPS) && !fuzzyEquals(x, y, EPS);
	}
	
	/**
	 * Returns true if x < y (with default eps)
	 */
	 ...
	 * Returns true if x > y (with precision eps)
	 */
	public static boolean fuzzyGreaterThan(double x, double y, double EPS)
	{
		return fuzzyGreaterThan(x, y, EPS) && !fuzzyEquals(x, y, EPS);
	}
